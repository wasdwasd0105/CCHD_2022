...
class Delegate(DefaultDelegate):
    def __init__(self):
        ...
        PLETH_FILE = os.path.join(DATA_DIR, patient_id, patient_id + '_rpi_pleth_foot_file.csv')
        PULSE_OX_FILE = os.path.join(DATA_DIR, patient_id, patient_id + '_rpi_pulseox_foot_file.csv')
